...
Current milestone: the five-round synthetic offline game has been hardened from Claude's supplied review findings, and public Terms and Privacy pages now describe the current release. Independent re-review is the next proposed checkpoint. Real/live acquisition remains disabled.
