...
The acquisition ledger is separate from the closed spike ledger. Combined reporting begins with the documented three spike successes without importing that historical file. Acquisition is now frozen at exactly 100 combined successes: three spike plus 97 acquisition. The current Academy requirement says 100+ while the older campaign page says 1,000; organizer reconciliation remains necessary. The supplied final dashboard balance is 995, exactly 97 below the historical post-spike balance of 1,092 and equal to reported acquisition credits. A transient earlier 1,095 observation remains unexplained and is not evidence of extra usage or replenishment.

The bounded workflow first made six discovery calls under prior authorization. Version 3 rejected all 600 returned rows; offline version 4 reprocessing later identified one qualifying row and one private candidate. Subsequent supplied aggregate evidence records 91 successful candidate-specific coverage calls with consistent wallet-filter enforcement, but page 91 remained nonterminal. The candidate therefore lacks complete coverage and cannot become a real round. No further discovery or coverage call is authorized. Separate clones/worktrees cannot coordinate the local lock or ledger and must not run live acquisition.
